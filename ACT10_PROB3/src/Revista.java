...
public class Revista extends Publicacion implements iPublicacion, iPrestable, iConsultable {
	
	public Revista(int iCodigo, String sAutor, String sTitulo, int iAnioPublicacion) {
