...
public class Libro extends Publicacion implements iPublicacion, iPrestable, iConsultable  {

	
	
	public Libro(int iCodigo, String sAutor, String sTitulo, int iAnioPublicacion) {
